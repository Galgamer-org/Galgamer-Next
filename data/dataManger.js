...
var update = function (vndbIdQueue, file) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                (0, dataQuery_2.clearJsonFile)(file);
                count = 0;
                _a.label = 1;
            case 1:
                if (!(count < vndbIdQueue.length)) return [3 /*break*/, 4];
                vndbId = vndbIdQueue[count];
                console.log("Updating ".concat(count + 1, " / ").concat(vndbIdQueue.length));
                return [4 /*yield*/, (0, dataQuery_1.default)(vndbId, file)];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
